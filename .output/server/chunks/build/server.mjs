import { defineComponent, ref, inject, watch, h, Suspense, Fragment, unref, provide, shallowReactive, hasInjectionContext, getCurrentInstance, version, defineAsyncComponent, computed, createApp, shallowRef, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext, Text } from 'vue';
import { c as createError$1, k as klona, i as defuFn, s as sanitizeStatusCode, j as getContext, $ as $fetch$1, l as baseURL, m as createHooks, t as toRouteMatcher, n as createRouter$1, o as defu, q as destr, r as getRequestHeaders, v as parse$1, w as getRequestHeader, x as isEqual$1, y as setCookie, z as getCookie, A as deleteCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "contact___en",
    path: "/contact",
    component: () => import('./contact-CJ-GTCtm.mjs')
  },
  {
    name: "contact___fr",
    path: "/fr/contact",
  ...
  },
  {
    name: "index___en",
    path: "/",
    component: () => import('./index-DX79vdJz.mjs')
  },
  {
    name: "index___fr",
    path: "/fr",
  ...
  },
  {
    name: "services___en",
    path: "/services",
    component: () => import('./services-DaQKvI8t.mjs')
  },
  {
    name: "services___fr",
    path: "/fr/services",
...
const LazyIcon = defineAsyncComponent(() => import('./index-C-gVn7X_.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CFGey2jJ.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-zUGZie9h.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-W7JaVKdf.mjs'));
...
export { _export_sfc as _, __nuxt_component_0 as a, useNuxtApp as b, useRuntimeConfig as c, withoutTrailingSlash as d, entry$1 as default, nuxtLinkDefaults as e, asyncDataDefaults as f, createError as g, hasProtocol as h, useAppConfig as i, joinURL as j, injectHead as k, resolveUnrefHeadInput as l, navigateTo as n, parseQuery as p, resolveRouteObject$1 as r, useRouter as u, withTrailingSlash as w };
